...
class UpDownIndicator extends StatelessWidget {
  ...
  const UpDownIndicator._(this.progress, this.value, this.description, this.onPressed, this._type);
                ...
                if (progress != null) ...[
                  DecoratedBox(
                    decoration: BoxDecoration(
                      color: _type.when(up: const Color(0xff91C73C), down: const Color(0xffC7513C)),
