...
class BasicTextField<U> extends FieldObject<U> {
  ...
  factory BasicTextField(U input,
          {LengthValidator<U>? other, bool validate = true}) =>
  ...
  BasicTextField<U> operator +(other) {
    ...
    else if (typesEqual<U, double?>() &&
        (other is double || other is double?)) {
      if (other == null) return copyWith(getOrNull as U);
      final _other = other as double;
      return copyWith((0.0 + _other) as U);
    }
    if ((typesEqual<U, String>() || typesEqual<U, String?>()) &&
        other is String) return copyWith(('$getOrEmpty' + other) as U);
    return this;
  }
  ...
  BasicTextField<U> operator -(num other) {
    if (typesEqual<U, int>())
      return copyWith(((getOrNull as int) - other) as U);
    if (typesEqual<U, int?>())
      return copyWith(((getOrNull as int? ?? 0) - other) as U);
    if (typesEqual<U, double>())
      return copyWith(((getOrNull as double) - other) as U);
    if (typesEqual<U, double?>())
      return copyWith(((getOrNull as double? ?? 0) - other) as U);
    if (typesEqual<U, num>())
      return copyWith(((getOrNull as num) - other) as U);
