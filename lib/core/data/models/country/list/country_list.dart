...
CountryDTOList deserializeCountryDTOList(Map<String, dynamic> json) =>
    CountryDTOList.fromJson(json);
Map<String, dynamic> serializeCountryDTOList(CountryDTOList object) =>
    object.toJson();
