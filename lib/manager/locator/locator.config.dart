...
import 'package:auctionvillage/features/auth/data/sources/remote/auth_remote_source.dart'
    as _i35;
import 'package:auctionvillage/features/auth/domain/index.dart' as _i37;
...
import 'package:auctionvillage/features/dashboard/presentation/managers/wallet/wallet_cubit.dart'
    as _i34;
import 'package:auctionvillage/manager/locator/modules/modules.dart' as _i41;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> $initGetIt(
    ...
    await gh.factoryAsync<_i21.SharedPreferences>(
        ...
        preResolve: true);
    gh.factory<_i22.SocketIOClient>(() => _i22.SocketIOClient.intance());
    ...
    gh.lazySingleton<_i26.WalletLocal>(
        () => _i26.WalletLocal(get<_i16.Localstore>()));
    ...
    gh.singleton<_i29.AuthLocalDatasource>(_i29.AuthLocalDatasource(
        get<_i3.AccessTokenManager>(), get<_i4.HiveClient>()));
    gh.factory<_i30.DealRepository>(() => _i30.DealRepository(
        get<_i15.InternetConnectionChecker>(),
        get<_i8.Connectivity>(),
        get<_i9.DealRemote>()));
    gh.singleton<_i31.PreferenceRepository>(
        _i31.PreferenceRepository(get<_i21.SharedPreferences>()));
    gh.factory<_i32.ProductBloc>(() => _i32.ProductBloc(
        get<_i30.DealRepository>(),
        get<_i16.Localstore>(),
        get<_i7.CloudinaryPublic>()));
    gh.factory<_i33.SearchBloc>(
        () => _i33.SearchBloc(get<_i20.SearchRemote>()));
    gh.factory<_i34.WalletCubit>(() => _i34.WalletCubit(
        get<_i28.WalletRepository>(),
        get<_i19.PaystackPlugin>(),
        get<_i22.SocketIOClient>(),
        get<_i10.FirebaseAnalytics>()));
    gh.singleton<_i35.AuthRemoteDatasource>(_i35.AuthRemoteDatasource(
        get<_i4.AppHttpClient>(), get<_i31.PreferenceRepository>()));
    gh.factory<_i36.DealCubit>(
        () => _i36.DealCubit(get<_i30.DealRepository>()));
    gh.lazySingleton<_i37.AuthFacade>(() => _i38.AuthFacadeImpl(
        get<_i35.AuthRemoteDatasource>(),
        get<_i29.AuthLocalDatasource>(),
        get<_i14.GoogleSignIn>(),
        get<_i10.FirebaseAnalytics>(),
        get<_i31.PreferenceRepository>()));
    gh.singleton<_i39.AuthWatcherCubit>(_i39.AuthWatcherCubit(
        get<_i37.AuthFacade>(), get<_i25.UtilitiesRepository>()));
    gh.factory<_i40.AuthCubit>(() => _i40.AuthCubit(get<_i37.AuthFacade>(),
        get<_i31.PreferenceRepository>(), get<_i7.CloudinaryPublic>()));
    return this;
  }
}

class _$AppModules extends _i41.AppModules {}

class _$ServiceModules extends _i41.ServiceModules {}

class _$FirebaseModules extends _i41.FirebaseModules {}
