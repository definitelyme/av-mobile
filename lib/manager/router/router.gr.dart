...
import 'package:auctionvillage/core/domain/entities/entities.dart' as _i13;
...
import 'package:auctionvillage/features/dashboard/domain/index.dart' as _i12;
...
class AppRouter extends _i7.RootStackRouter {
  ...
  final Map<String, _i7.PageFactory> pagesMap = {
    ...
    PricingPlanRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData,
          child: const _i3.PricingPlanScreen(),
          fullscreenDialog: true,
          title: 'Pricing Plan');
    },
    ...
    CountryPickerRoute.name: (routeData) {
      ...
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i5.CountryPickerScreen(args.initial,
              key: args.key, countries: args.countries),
          fullscreenDialog: true);
    },
    AppearanceRoute.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i4.AppearanceScreen());
    },
    ...
    LivePage.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i8.LivePage());
    },
    SellPage.name: (routeData) {
      return _i7.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i8.SellPage());
    },
  ...
  List<_i7.RouteConfig> get routes => [
        _i7.RouteConfig(SplashRoute.name,
        ...
        _i7.RouteConfig(ForgotPasswordRoute.name,
            ...
            usesPathAsKey: true,
            guards: [guestGuard]),
        _i7.RouteConfig(PasswordResetRoute.name,
            path: '/password-reset-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [guestGuard]),
        _i7.RouteConfig(PhoneVerificationRoute.name,
        ...
        _i7.RouteConfig(DashboardRoute.name,
            ...
            children: [
              ...
              _i7.RouteConfig(LiveRouter.name,
                  path: 'empty-router-page',
                  parent: DashboardRoute.name,
                  children: [
                    _i7.RouteConfig(LivePage.name,
              ...
              _i7.RouteConfig(SellRouter.name,
                  path: 'empty-router-page',
                  parent: DashboardRoute.name,
                  children: [
                    _i7.RouteConfig(SellPage.name,
              ...
              _i7.RouteConfig(MoreRouter.name,
                  path: 'empty-router-page',
                  parent: DashboardRoute.name,
                  children: [
                    _i7.RouteConfig(MorePage.name,
        ...
        _i7.RouteConfig(DealDetailRoute.name,
            path: '/deal-detail-screen', fullMatch: true, usesPathAsKey: true),
        _i7.RouteConfig(DealsListRoute.name,
            path: '/deals-list-screen', fullMatch: true, usesPathAsKey: true),
        _i7.RouteConfig(ProductListRoute.name,
            path: '/product-list-screen', fullMatch: true, usesPathAsKey: true),
        _i7.RouteConfig(FundWalletRoute.name,
            path: '/fund-wallet-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(WithdrawalRoute.name,
            path: '/withdrawal-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(TransactionPinSetupRoute.name,
            path: '/transaction-pin-setup-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(ForgotTransactionPinRoute.name,
            path: '/forgot-transaction-pin-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(WalletHistoryRoute.name,
            path: '/wallet-history-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(MyBidsRoute.name,
            path: '/my-bids-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(MySellingsRoute.name,
            path: '/my-sellings-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(MyWishlistRoute.name,
            path: '/my-wishlist-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(MyReviewsRoute.name,
            path: '/my-reviews-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(EditProfileRoute.name,
            path: '/edit-profile-screen',
            fullMatch: true,
            usesPathAsKey: true,
            guards: [authGuard]),
        _i7.RouteConfig(PricingPlanRoute.name,
            path: '/pricing-plan-screen', fullMatch: true, usesPathAsKey: true),
        _i7.RouteConfig(SuccessRoute.name,
            path: '/success-screen', fullMatch: true, usesPathAsKey: true),
        _i7.RouteConfig(CountryPickerRoute.name,
            path: '/country-picker-screen',
            fullMatch: true,
            usesPathAsKey: true),
        _i7.RouteConfig(AppearanceRoute.name,
            path: '/appearance-screen', fullMatch: true, usesPathAsKey: true)
      ];
}
...
class LoginRoute extends _i7.PageRouteInfo<LoginRouteArgs> {
  LoginRoute({_i11.Key? key, Object? btnHeroTag})
...
class DealDetailRoute extends _i7.PageRouteInfo<DealDetailRouteArgs> {
  DealDetailRoute({required _i12.Deal deal, _i11.Key? key})
...
/// generated route for
/// [_i3.DealsListScreen]
class DealsListRoute extends _i7.PageRouteInfo<DealsListRouteArgs> {
  DealsListRoute(
      {required String title,
      _i11.Key? key,
      bool? isPrivate,
      _i12.DealType? type,
      _i12.BidStatus? bidStatus,
      _i12.DealCategory? category})
...
class DealsListRouteArgs {
  ...
  final _i12.DealType? type;

  final _i12.BidStatus? bidStatus;

  final _i12.DealCategory? category;
...
class FundWalletRoute extends _i7.PageRouteInfo<void> {
...
class WithdrawalRoute extends _i7.PageRouteInfo<void> {
...
class TransactionPinSetupRoute
    extends _i7.PageRouteInfo<TransactionPinSetupRouteArgs> {
...
class ForgotTransactionPinRoute extends _i7.PageRouteInfo<void> {
...
class WalletHistoryRoute extends _i7.PageRouteInfo<void> {
...
/// generated route for
/// [_i3.MyBidsScreen]
class MyBidsRoute extends _i7.PageRouteInfo<void> {
...
class MySellingsRoute extends _i7.PageRouteInfo<void> {
...
class MyWishlistRoute extends _i7.PageRouteInfo<void> {
...
/// generated route for
/// [_i3.MyReviewsScreen]
class MyReviewsRoute extends _i7.PageRouteInfo<void> {
...
class EditProfileRoute extends _i7.PageRouteInfo<EditProfileRouteArgs> {
  EditProfileRoute({required _i13.User? user, _i11.Key? key})
...
class PricingPlanRoute extends _i7.PageRouteInfo<void> {
  const PricingPlanRoute()
      : super(PricingPlanRoute.name, path: '/pricing-plan-screen');
...
/// generated route for
/// [_i5.CountryPickerScreen]
class CountryPickerRoute extends _i7.PageRouteInfo<CountryPickerRouteArgs> {
  CountryPickerRoute(
      {required _i13.Country? initial,
      _i11.Key? key,
      _i6.KtList<_i13.Country> countries = const _i6.KtList.empty()})
...
class CountryPickerRouteArgs {
  const CountryPickerRouteArgs(
      ...
      this.key,
      this.countries = const _i6.KtList.empty()});

  final _i13.Country? initial;

  final _i11.Key? key;

  final _i6.KtList<_i13.Country> countries;
...
/// generated route for
/// [_i4.AppearanceScreen]
class AppearanceRoute extends _i7.PageRouteInfo<void> {
  const AppearanceRoute()
      : super(AppearanceRoute.name, path: '/appearance-screen');
...
/// generated route for
/// [_i7.EmptyRouterPage]
class LiveRouter extends _i7.PageRouteInfo<void> {
  const LiveRouter({List<_i7.PageRouteInfo>? children})
...
/// generated route for
/// [_i7.EmptyRouterPage]
class SellRouter extends _i7.PageRouteInfo<void> {
  const SellRouter({List<_i7.PageRouteInfo>? children})
...
/// generated route for
/// [_i7.EmptyRouterPage]
class MoreRouter extends _i7.PageRouteInfo<void> {
  const MoreRouter({List<_i7.PageRouteInfo>? children})
...
/// generated route for
/// [_i8.LivePage]
class LivePage extends _i7.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.SellPage]
class SellPage extends _i7.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.MorePage]
class MorePage extends _i7.PageRouteInfo<void> {
