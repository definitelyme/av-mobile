...
class AdaptiveAlertdialog<B extends Object?> extends StatelessWidget {
                  ...
                  App.platform.fold(
                    ...
                    material: () => buttonDirection == Axis.vertical
                        ? Column(children: [
                            ...
                            //
                            firstButtonText?.let((it) => VerticalSpace(
                                    height: materialButtonVerticalGap)) ??
                        ...
                        : Row(
                            ...
                            children: [
                              ...
                              //
                              firstButtonText?.let((it) => HorizontalSpace(
                                      width: materialButtonHorizontalGap)) ??
                                  (materialFirstButton == null
                                      ? const Spacer(flex: 2)
                                      : HorizontalSpace(
                                          width: materialButtonHorizontalGap)),
        ...
        (it) => AdaptiveButton(
          onPressed: () async {
            if (autoPopFirstButton)
              unawaited(navigator.pop((await onFirstPressedFuture?.call()) ??
                  onFirstPressed?.call() ??
                  defaultValue));
            else
  ...
  MaterialAlertDialogData _materialAlertDialogData(BuildContext c) =>
      MaterialAlertDialogData(
        ...
        titleTextStyle: DefaultTextStyle.of(c).style.merge(
      ...
      AdaptiveButton(
        onPressed: () async {
          if (autoPopSecondButton)
            unawaited(navigator.pop((await onSecondPressedFuture?.call()) ??
      ...
      child: MediaQuery.removeViewInsets(
        ...
        child: material
            ? AlertDialog(
                ...
                backgroundColor:
                    _materialAlertDialogData(context).backgroundColor!,
                ...
                contentPadding: contentPadding ??
                    _materialAlertDialogData(context).contentPadding!,
                titleTextStyle:
                    _materialAlertDialogData(context).titleTextStyle!,
                          ...
                          (it) => TextButton(
                            style: TextButton.styleFrom(
                              splashFactory: CustomSplashFactory(
                                splashColor: App.resolveColor(Colors.black12,
            ...
            : Theme(
                data: Utils.platform_(
                  cupertino: App.isDarkMode(context)
                      ? ThemeData.dark()
                      : ThemeData.light(),
