...
class _AdaptiveFullscreenState extends State<AdaptiveFullscreen> {
  ...
  dynamic get minScale => widget.containMinScale || widget.minScale == null
      ? PhotoViewComputedScale.contained
      : widget.minScale;
  dynamic get maxScale =>
      widget.maxScale ?? PhotoViewComputedScale.covered * 2.0;
                ...
                child: PhotoView(
                  ...
                  backgroundDecoration: BoxDecoration(
                      color: App.resolveColor(Colors.transparent,
                          dark: Colors.black87.withOpacity(0.9))),
                  ...
                  loadingBuilder: (_, chunk) => CircularProgressBar.adaptive(
                    ...
                    value: chunk != null
                        ? (chunk.cumulativeBytesLoaded /
                            chunk.expectedTotalBytes!.toDouble())
                        : 0,
                  ),
                ),
              ),
