...
class ReactiveTextFormField<Reactive extends BlocBase<ReactiveState>,
  ...
  Widget _child(ReactiveState s) => heroTag != null && !heroTag.isBlank
      ? Hero(tag: heroTag!, child: _input(s))
      : _input(s);
