...
class WidgetShimmer extends StatelessWidget {
  ...
  const WidgetShimmer({
    ...
    this.loop = true,
  })  : assert((shimmerBuilder == null && child != null) ||
            (shimmerBuilder != null && child == null)),
        super(key: key);

  Color get _boxColor => boxColor ?? Colors.grey.shade400;
  Color get _shimmerBaseColor =>
      shimmerBaseColor ??
      App.resolveColor(Colors.grey.shade300, dark: Colors.grey.shade600)!;
  Color get _shimmerHighlightColor =>
      shimmerHighlightColor ??
      App.resolveColor(Colors.grey.shade200, dark: Colors.grey.shade500)!;
              ...
              child: ClipRRect(
                ...
                child: DecoratedBox(
                  decoration: BoxDecoration(
                      color: _boxColor, borderRadius: borderRadius),
