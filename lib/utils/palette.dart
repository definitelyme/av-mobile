...
class Palette {
  ...
  static const _accentPrivate = 0xff0052BD;
  ...
  static const Color text100 = Color(0xFF142550);
  ...
  static const Color inputLabelDark = Color(0xFFACACAC);
  ...
  static const Color inputLightBorderColor = Color(0xffDCDCDC);
  static const Color inputLightBorderFocusedColor = Colors.black45;
  static const Color inputDarkBorderColor = Colors.white38;
  static const Color inputDarkBorderFocusedColor = Color(0xffDCDCDC);
  static const Color disabledBorderLight = Color(0xff848484);
  static const Color disabledBorderDark = Color(0xff6e6e6e);
