  ...
  T fold<T>({
    ...
    switch (code) {
      case Failure.UNAUTHENTICATED:
        return is401 != null ? is401.call() : orElse.call();
      case 404:
        return is404 != null ? is404.call() : orElse.call();
      case Failure.INCOMPLETE_PROFILE:
        return is41101 != null ? is41101.call() : orElse.call();
      case Failure.UNVERIFIED_PHONE:
        return is4031 != null ? is4031.call() : orElse.call();
      default:
